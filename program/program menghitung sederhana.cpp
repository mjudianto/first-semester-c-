/*//Program menghitung keliling segiempat
#include<iostream>
using namespace std;

int main()
{
	float panjang,lebar,kell;
	cout<<"PROGRAM MENGHITUNG KELILING SEGIEMPAT";
	cout<<endl;
	cout<<endl;
	...
	cout<<"Keliling segiempat : "<<kell<<endl;
}
*/
...
int main()
{
	...
	cout<<endl;
	cout<<endl;
	cout<<"Ketikkan nama pegawai : ";		// ketikkan nama tanpa menggunakan spasi
	cin>>N; cout<<endl;
	cout<<"Ketikkan jumlah real estate yang anda jual : ";
	cin>>J; cout<<endl;
	cout<<"Ketikkan total nilai jual real estate yang anda jual : ";
	cin>>T; cout<<endl;
	K = 100000*J+T/100;
	cout<<"Total komisi penjualan : "<<K<<endl;
	cout<<endl;
	TG = 400000+K;
	cout<<"Total gaji anda bulan ini sebesar : "<<TG<<endl;
}
*/
